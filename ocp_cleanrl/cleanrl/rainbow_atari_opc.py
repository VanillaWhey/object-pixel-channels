...
class Args:
    ...
    obs_mode: Literal[
        "dqn", "obj", "object_channels", "object_channels+pixels"
    ] = "dqn"
    ...
    masked_wrapper: str = ""
    """The wrapper to use; set during runtime"""
...
def make_env(env_id, seed, idx, capture_video, run_name):
    def thunk():
        ...
        if args.masked_wrapper == "object_channels":
           env = ocatari_wrappers.ObjectChannelsWrapper(env, buffer_window_size=args.buffer_window_size)
        elif args.masked_wrapper is not None:
            raise NotImplementedError(f"Observation mode {args.masked_wrapper} not supported!")
...
"""
    ...
    rtpt = RTPT(name_initials=args.author, experiment_name='OCP_Rainbow',
